...
<head>
  ...
  <title>One Media SA</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/ONEMEDIA.png" rel="icon">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="#portfolio">Casos de Sucesso</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>One Media SA</h1>
          <h2>Media e Gestão de Eventos</h2>
          <div class="d-flex">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="icon-box">
              ...
              <p class="description">Ser referência nos mercados de Comunicacao e Eventos
                do país, África e do mundo pela entrega de serviços com
                qualidade, dinamismo e eficiência.</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p class="description">Inovar continuamente a forma de comunicar para maximizar
                a eficácia dos esforços dos nossos clientes, agregando valor
                aos seus produtos e serviços.</p>
            </div>
          </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <span>Serviços</span>
          <h2>Serviços</h2>
          <p>Delicie-se da nossa carteira de serviços</p>
        </div>
    ...
    <section id="testimonials" class="testimonials section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h2>Testemunhos</h2>
          <p>O que os clientes dizem sobre nós</p>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Ficamos tranquilos sempre que podemos contar com a produção da Onemedia, porque é sucesso garantido.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
                <h3>Adélio Dias</h3>
                <h4>Dir. Com. Imagem | CFM</h4>
              </div>
            </div><!-- End testimonial item -->
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <span>Equipa</span>
          <h2>Equipa</h2>
          <p>Pessoal-chave para o sucesso da One Media SA</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <span>MEMBRO DO CONSELHO DE ADMINISTRAÇÃO, ONEMEDIA</span>
              <p>
                Licenciado em Economia pela Universidade Eduardo Mondlane.
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <span>MEMBRO DO CONSELHO DE ADMINISTRAÇÃO, ONEMEDIA</span>
              <p>
                Licenciado em Ciências de Comunicação e distinguido Melhor Estudante do Curso em 2013, pelo ISCTEM - BS.
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <h4>José F. Rodrigues Alho</h4>
              <span>DIRECÇÃO DE ATENDIMENTO</span>
              <p>
                Técnico médio em Gestão de Marketing pelo Colégio Albergaria, Gestor de clientes e técnico de vendas.
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <span>DIRECTOR DE PRODUÇÃO
                ABOVE THE LINE</span>
              <p>
                Técnico de impressão digital com 10 anos de experiência em produção gráfica offset.
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member">
              ...
              <span>DIRECTORA DE PRODUÇÃO
                BELOW THE LINE</span>
              <p>
                Gestora de Eventos, Apresentadora de Televisão (TVM), formanda em Direito pela UEM.
              </p>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <span>Contacto</span>
          <h2>Contacto</h2>
          <p>Saiba quem somos e o que podemos realizar</p>
        </div>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="my-3">
                ...
                <div class="error-message">Email não enviado! Contacte o Suporte.</div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>One Media SA</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Desenvolvido por <a href="https://onemediamoz.com/" target="_blank">One Media SA</a>
      </div>
    </div>
  </footer><!-- End Footer -->
